...
public sealed class DataShapingService
{
    ...
    public ExpandoObject Shape<T>(T entity, string? fields)
    {
        return ShapeMany([entity], fields)[0];
    }
    
    public List<ExpandoObject> ShapeMany<T>(IEnumerable<T> entities, string? fields)
    {
